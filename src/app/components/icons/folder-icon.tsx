...
export default function FolderIcon({ width = 24, height = 24, ...props }: FolderIconProps) {
    return (
        <svg width={width} height={height} viewBox='0 0 18 19' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
            <path
